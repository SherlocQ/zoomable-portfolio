      ...
      items: [
        {
          ...
          items: [
            ...
            { id: 'motion-clock',    type: 'page', label: 'Clock',            span: [1,1], tone: 'image', bg: '#f6fbfb', image: '/images/craft/motion-clock.gif',   content: { type: 'image', src: '/images/craft/motion-clock.gif',   caption: 'Clock animation' } },
            { id: 'motion-loader',   type: 'page', label: 'Loader',           span: [1,1], tone: 'image', bg: '#f6fbfb', image: '/images/craft/motion-loader.gif',  content: { type: 'image', src: '/images/craft/motion-loader.gif',  caption: 'Loader animation' } },
            { id: 'motion-bubble',   type: 'page', label: 'Bubble',           span: [1,1], tone: 'image', bg: '#f1e4e5', image: '/images/craft/motion-bubble.gif',  content: { type: 'image', src: '/images/craft/motion-bubble.gif',  caption: 'Bubble animation' } },
            { id: 'motion-stepped',  type: 'page', label: 'Stepped Animation',span: [2,1], tone: 'image', bg: '#f1e4e5', image: '/images/craft/motion-stepped.gif', content: { type: 'image', src: '/images/craft/motion-stepped.gif', caption: 'Stepped animation' } },
            { id: 'motion-beaker',   type: 'page', label: 'Beaker',           span: [1,1], tone: 'image', bg: '#000000', image: '/images/craft/motion-beaker.gif',  content: { type: 'image', src: '/images/craft/motion-beaker.gif',  caption: 'Beaker animation' } },
            { id: 'motion-splash',   type: 'page', label: 'Splash Animation', span: [2,1], tone: 'image', bg: '#000000', image: '/images/craft/motion-splash.gif',  content: { type: 'image', src: '/images/craft/motion-splash.gif',  caption: 'Splash animation' } },
            { id: 'motion-break',    type: 'page', label: 'Break Text',       span: [2,1], tone: 'image', bg: '#000000', image: '/images/craft/motion-break.gif',   content: { type: 'image', src: '/images/craft/motion-break.gif',   caption: 'Break text animation' } },
          ],
        },
        {
          id: 'craft-print',
