...
- Hero and all project heroes use the shared 20×34px tertiary `ScrollCue`: visual-viewport centered, 24px from the relevant bottom edge, hidden after leaving scroll top, restored at top, and responsive across the 50/50 mobile Hero layout.
