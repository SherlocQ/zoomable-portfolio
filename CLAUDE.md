...
- Craft cards share the Projects compact bottom-vignette geometry and white label treatment. Fine-detail GIF/print thumbnails intentionally omit progressive blur so raster lines remain crisp. Project previews use four independent image bands (0.35–2.5px) in the lower 34%; project heroes use six independent image bands (0.35–5px) in the lower 24%. Data Visualization uses the same project-card and project-hero treatment.
